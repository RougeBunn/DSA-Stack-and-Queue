...
function squareDance(q) {
  ...
  console.log(`There are ${remainingM} male dancers in line`);
  console.log(`There are ${remainingF} female dancers in line`);
}
...
function ophidianBank() {
  ...
  while (bank.first !== null) {
    ...
    if (chance === 4) {
      let person = bank.dequeue();
      bank.enqueue(person);
      console.log('back of the line,', person);
    } else {
